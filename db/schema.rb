...
ActiveRecord::Schema.define(version: 2020_01_13_095205) do
  ...
  create_table "relations", force: :cascade do |t|
    ...
    t.index ["transaction_item_id"], name: "index_relations_on_transaction_item_id"
  end
  ...
  add_foreign_key "relations", "transaction_items"
